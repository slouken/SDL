...
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_R8_FORMAT, SDL_PIXELFORMAT_R8 == SDL_DEFINE_PIXELFORMAT(SDL_PIXELTYPE_ARRAYU8, SDL_ARRAYORDER_R, 0, 8, 1));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_R8_FOURCC, !SDL_ISPIXELFORMAT_FOURCC(SDL_PIXELFORMAT_R8));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_R8_INDEXED, !SDL_ISPIXELFORMAT_INDEXED(SDL_PIXELFORMAT_R8));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_R8_PACKED, !SDL_ISPIXELFORMAT_PACKED(SDL_PIXELFORMAT_R8));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_R8_ARRAY, SDL_ISPIXELFORMAT_ARRAY(SDL_PIXELFORMAT_R8));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_R8_10BIT, !SDL_ISPIXELFORMAT_10BIT(SDL_PIXELFORMAT_R8));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_R8_FLOAT, !SDL_ISPIXELFORMAT_FLOAT(SDL_PIXELFORMAT_R8));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_R8_ALPHA, !SDL_ISPIXELFORMAT_ALPHA(SDL_PIXELFORMAT_R8));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_R8G8_FORMAT, SDL_PIXELFORMAT_R8G8 == SDL_DEFINE_PIXELFORMAT(SDL_PIXELTYPE_ARRAYU8, SDL_ARRAYORDER_RG, 0, 16, 2));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_R8G8_FOURCC, !SDL_ISPIXELFORMAT_FOURCC(SDL_PIXELFORMAT_R8G8));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_R8G8_INDEXED, !SDL_ISPIXELFORMAT_INDEXED(SDL_PIXELFORMAT_R8G8));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_R8G8_PACKED, !SDL_ISPIXELFORMAT_PACKED(SDL_PIXELFORMAT_R8G8));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_R8G8_ARRAY, SDL_ISPIXELFORMAT_ARRAY(SDL_PIXELFORMAT_R8G8));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_R8G8_10BIT, !SDL_ISPIXELFORMAT_10BIT(SDL_PIXELFORMAT_R8G8));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_R8G8_FLOAT, !SDL_ISPIXELFORMAT_FLOAT(SDL_PIXELFORMAT_R8G8));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_R8G8_ALPHA, !SDL_ISPIXELFORMAT_ALPHA(SDL_PIXELFORMAT_R8G8));

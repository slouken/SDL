...
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_I010_FORMAT, SDL_PIXELFORMAT_I010 == SDL_DEFINE_PIXELFOURCC('I', '0', '1', '0'));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_I010_FOURCC, SDL_ISPIXELFORMAT_FOURCC(SDL_PIXELFORMAT_I010));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_I010_INDEXED, !SDL_ISPIXELFORMAT_INDEXED(SDL_PIXELFORMAT_I010));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_I010_PACKED, !SDL_ISPIXELFORMAT_PACKED(SDL_PIXELFORMAT_I010));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_I010_ARRAY, !SDL_ISPIXELFORMAT_ARRAY(SDL_PIXELFORMAT_I010));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_I010_10BIT, !SDL_ISPIXELFORMAT_10BIT(SDL_PIXELFORMAT_I010));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_I010_FLOAT, !SDL_ISPIXELFORMAT_FLOAT(SDL_PIXELFORMAT_I010));
SDL_COMPILE_TIME_ASSERT(SDL_PIXELFORMAT_I010_ALPHA, !SDL_ISPIXELFORMAT_ALPHA(SDL_PIXELFORMAT_I010));
